<x-pelican::layout :service="$service" :settings="$settings" view="overview">
            ...
            <div class="bg-background-secondary border border-neutral p-4 rounded-lg">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="w-full bg-background rounded-full h-2 border border-neutral overflow-hidden">
                            <div class="h-2 rounded-full bg-success/60 border border-success" style="width: 50%"></div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="w-full bg-background rounded-full h-2 border border-neutral overflow-hidden">
                            <div class="h-2 rounded-full bg-warning/60 border border-warning" style="width: 30%"></div>
                        </div>
                    </div>
                </div>
            </div>
