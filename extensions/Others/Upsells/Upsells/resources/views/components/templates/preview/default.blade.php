...
<div class="preview-default" style="background-color: {{ $bgSecondary }}; border: 1px solid {{ $borderColor }}; border-radius: {{ $borderRadius }}px; padding: 1.25rem; margin-bottom: 1rem;">
