...
<div class="preview-transparent" style="background-color: transparent; border-radius: 0; padding: 0 1.25rem; margin-bottom: 1rem; border: none; border-left: 5px solid {{ $primaryColor }}; display: flex; align-items: center; justify-content: space-between; gap: 1.5rem;">
    <div style="flex: 1;">
