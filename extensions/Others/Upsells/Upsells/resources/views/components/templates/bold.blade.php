...
<div style="background-color: {{ $bgSecondary }}; border-radius: {{ $borderRadius }}px; padding: 1.25rem; margin-bottom: 1rem; border: 1px solid {{ $borderColor }}; border-left: 4px solid {{ $primaryColor }}; display: flex; align-items: center; justify-content: space-between; gap: 1.5rem;">
    <div style="flex: 1;">
