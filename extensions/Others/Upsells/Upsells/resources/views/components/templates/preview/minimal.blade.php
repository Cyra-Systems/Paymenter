...
<div class="preview-minimal" style="display: flex; align-items: center; gap: 1rem; padding: 1rem; border-bottom: 1px solid {{ $borderColor }}; background-color: transparent;">
