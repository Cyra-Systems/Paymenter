...
<head>
    ...
    @endif
    @isset($title)
    <meta content="{{ isset($title) ? config('app.name') . ' - ' . $title : config('app.name') }}" property="og:title">
    <meta content="{{ isset($title) ? config('app.name') . ' - ' . $title : config('app.name') }}" name="title">
    @endisset
    @isset($description)
